            ...
            <div className={styles.formWrapper}>
              ...
              <form onSubmit={handleSubmit} noValidate className={styles.form}>
                ...
                <div className={styles.formGroup}>
                  ...
                  />
                  {errors.fullName && (
                    <span className={styles.invalidFeedback}>{errors.fullName}</span>
                  )}
                </div>
                ...
                <div className={styles.formGroup}>
                  ...
                  />
                  {errors.phone && (
                    <span className={styles.invalidFeedback}>{errors.phone}</span>
                  )}
                </div>
                ...
                <div className={styles.formRow}>
                  <div className={styles.formGroup}>
                    ...
                    />
                    {errors.date && (
                      <span className={styles.invalidFeedback}>{errors.date}</span>
                    )}
                  </div>
                  <div className={styles.formGroup}>
                    ...
                    />
                    {errors.time && (
                      <span className={styles.invalidFeedback}>{errors.time}</span>
                    )}
                  </div>
                </div>
                ...
                <div className={styles.formGroup}>
                  ...
                  />
                  {errors.guests && (
                    <span className={styles.invalidFeedback}>{errors.guests}</span>
                  )}
                </div>
